  ...
  return (
    ...
    >
      <div className="hiyo-section-reveal relative z-10 mx-auto w-full max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 items-stretch gap-5 md:grid-cols-[1.08fr_0.92fr] lg:gap-7">
          <div className="hiyo-hover-card rounded-[28px] border border-white/70 bg-white/80 p-5 shadow-[0_18px_45px_rgba(31,79,122,0.14)] backdrop-blur-[3px] sm:p-6">
                ...
                return (
                  <article key={item.id} className="relative">
                    ...
                    <button
                      ...
                      className={`hiyo-hover-card block w-full rounded-[22px] border p-4 text-left shadow-[0_10px_24px_rgba(31,79,122,0.08)] transition-all hover:-translate-y-0.5 ${
                        isSelected
          ...
          <aside className="hiyo-hover-card rounded-[28px] border border-white/75 bg-white/80 p-5 shadow-[0_18px_45px_rgba(31,79,122,0.14)] backdrop-blur-[3px] sm:p-6">
